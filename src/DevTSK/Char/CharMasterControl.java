...
public class CharMasterControl {
	...
	public static void main(String[] args){
		...
		if (args.length == 0 || (args.length > 0 && args[0].equalsIgnoreCase("RP"))){
				...
				altnames = new String[] {"Radon", "Orange", "Shyne", "Jet", "Firefly", "Radium", "Tree", "Jack", "Zane", "Axel", "Dark", "C4", "C5", "Pizza-ponii", "Galecia", "Blazer", "Sean", "Dest", "test", "Krystal","Cosmos","Saturnus","Nephthys"}; 
				...
				oc = new Ponii[] {
					...
					new Ponii("Nephthys Darkstar","\nMare\nDemon\nFurpus\nSister of Cosmos\nBlight","\nSharp angular sword in an Orcish style","Unknown","King of Hell",9481,"Nephthys.png","null.png","0",0,8,-7466)
				}; 
				nonoc = new Ponii[] {

...
public class OOPCharRP {
	...
	private static final Ponii[] show = new Ponii[] {
		...
		new Ponii("Rainbow Dash", "\nMare\nPegasus\nRainbow Dash... need i say more?", "\nThe Rainbow lightning bolt", "?", "?", "Dark Rainbow", 23, "/images/RD.png"),
	};
	...
	private static void getOCInfo(int i) {
		...
		try{ 
			poni.lblPoniiPic.setIcon(poni.getImageIcn(OC[i].getImagePath()));
		} catch (IOException e) {

...
public class MasterControl {
	...
	public static void main(String[] args) throws ConfigException {
		...
		EntityLoader h = new EntityLoader(new Entity[] {
				...
				//check this line
				new UnMarriedPoniiWithKids/*Wrong Constructor : UnMarriedPonii expected*/("Cosmos Darkstar", "Cosmos", "\u26e7", false, "\nZebra pegasus\nIs half demon and is also a vampony\nLives in the old castle in Everfree", "\nPentagram", "Purple with gray stripes", "Gray", "Nighmare Moon", "King of Hell", 851, 21, 8, 1164 /*1, new String[] {""}, new String[] {""},*/, "null.png", "null.png", 1, new String[] { "" }, new String[] { "Cadence" }),
				//check this line
				new UnMarriedPonii("Miiryanth", "Miir", "", false, "\nDragon ponii\nI can haz dragon?"/*A better Desc would be nice*/, null /*He needs a new Class Delimiting the Cutii mark.*/, "Very dark gray", "Firey orange-red color", "Unknown", "Unknown", 19, 4, 8, 1996, "null.png", "null.png"),
		}, new Entity[] {

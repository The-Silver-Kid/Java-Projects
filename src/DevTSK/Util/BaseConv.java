...
public class BaseConv {
	...
	public String from10(long in, int base) throws Exception {
		if (base > table.length())
			throw new Exception("Base is too large");
		if (base < 2)
			throw new Exception("Base is too small");
		String out = "";
		while (in > 0) {
	...
	public long to10(String in, int base) throws Exception {
		if (base > table.length())
			throw new Exception("Base is too large");
		if (base < 2)
			throw new Exception("Base is too small");

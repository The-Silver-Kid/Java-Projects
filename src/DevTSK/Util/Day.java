/**
 * @author BigJava and The_Silver_Kid
 */
...
public class Day {
	...
	/**
	 * Returns the number of years between this day and another
	 * day.
	 * 
	 * @param other
	 *            the other day
	...
	/**
	 * Computes the next Year.
	 * 
	 * @return the year following this year
	 */
	private Day nextYear() {
		int y = year;
		int m = month;
		int d = date;
		y++;
	...
	/**
	 * Computes the previous Year.
	 * 
	 * @return the year preceding this day
	 */
	private Day previousYear() {
		int y = year;
		int m = month;
		int d = date;
		y--;

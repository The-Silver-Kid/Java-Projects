...
public class CharMasterControl {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0 || (args.length > 0 && args[0].equalsIgnoreCase("RP"))) {
			names = new String[] { "Shadow", "Steve", "Shyne", "Blitz", "Charrie", "Slanger", "Tree", "Jack", "Zane", "Axel", "Dark-Rainbow", "C418", "C523", "Steven", "Galecia", "Blaze", "Sean", "Destoliar", "Zelda", "Krystla", "Cosmos", "Saturnus", "Nephthys", "Hrodmar", "Morrigan", "Miiryanth", "Gorlanth", "Sniper Axe" };
			altnames = new String[] { "Radon", "Orange", "Shyne", "Jet", "Firefly", "Radium", "Tree", "Jack", "Zane", "Axel", "Dark", "C4", "C5", "Pizza-ponii", "Galecia", "Blazer", "Sean", "Dest", "Zelda", "Krystal", "Cosmos", "Saturnus", "Nepht", "Mar", "Morr", "Miir", "Lance", "Axx" };
 ...
 new Ponii("Charrie (Firefly) Sychace Radon", "", "\nMare\nPegasus\nPink Colour\nOld but cares allot about everyponii\nWhite Mane", "\nBlack Outlined White Thunderbolt", "Keri", "Craider", "Slanger", 67, 4, new String[] { "Shadow", "Shyne", "Steve", "Blitz" }, "charrie.png", "null.png", "2S2S000000FF89898000000000100FFFFUN1837000000001W17F2F2F9F4F4F1B107F3FCC004CB2", 13, 7, 1948),
					...
					//new Ponii("Galecia Frostia", "", "\nMare\nUnicorn\nLight blue coloured\nWas Radon's Marefriend for a while.... er, well still his marefreind.\nLikes the cold\nMane Even Lighter Blue", "\nIcicle", "Krystla", "Starliner", 20, 1, new String[] {"Powder"}, new String[] {"Shadow Radon"}, "Galecia.png", "null.png", "2W2O0001000095B900CCCC030010080FFUN1837000000000N10080FF00C0FF0N107F3FCC004CB2", 28, 4, 1995),
					...
					new Ponii("Zelda Fries", "", "\nStallion\nEarth Ponii\nGreen\nSuch sword\nYellow", "\nTriforce", "Nintendo", "Japan", 16, "null.png", "null.png", "0", 9, 6, -0),
			...
			oc = new Ponii[] {
					 ...
					 *
					 */
					new Ponii("Shadow Radon", "", "\nStallion\nUnicorn\nBlack Coloured\nYellow Thunderbolt accross underside\nYellow Thunderbolts arround hooves\nYellow and Black mane\nTeam TrigoPlexII Admin", "\nBlack Thundercloud with a yellow thunderbolt coming from it", "Charrie", "Slanger", "Apple Jack", 22, 7, new String[] { "Tree Lighting", "Shadow Jack", "Rhyne", "Aaron", "Powder", "Thorn", "Nhyte", "Morgan", "Drone", "Airlinear" }, new String[] { "Apple Jack", "Apple Jack", "Apple Jack", "Apple Jack", "Apple Jack", "Apple Jack", "Apple Jack", "Blitz Radon", "Blitz Radon", "Blitz Radon" }, "radon.png", "kloud.png", "bgm.ogg", "3037000200000000FEFF0003001FFFF00TM183720202000141000000FFFF001B107F3FCC004CB2", 20, 7, 1993), //002T0000040080FF00C0FF03001FFFF00UN1837000020000I10080FF00C0FF1B107F3FCC004CB2
					new Ponii("Steve (Orange) Radon", "", "\nStallion\nPegaus\nDark Orange Coloured\nWing style that of a alicorn\nMane colour is same as body colour but has a yellow streak in it\nTeam TrigoPlexII Admin", "\nSword.", "Charrie", "Slanger", 19, "orange.png", "Sword.png", "2S2S000200FF8800FFFF0003001FF0000UN183720F02000141FF8800FFFF001B107F3FCC004CB2", 20, 9, 1996), //002T000000FEA100FEB19E03001FFFF00UN1837000020000I10080FF00C0FF1B107F3FCC004CB2
					new Ponii("Shyne Radon", "", "\nMare\nEarth Ponii\nLight Blue Coloured\ncoat sparkles when exposed to light\nMane colour is a bit brighter then body color\nPrefers to not take sides", "\nA devide simbol with green lines connecting the sides", "Charrie", "Slanger", 20, "shyne.png", "null.png", "2S3H000004006FFF008AFF000010000FFUN183700300000141009FFF007FFF1B107F3FCC004CB2", 4, 6, 1995),

...
public class WindowPixl {
	...
	public WindowPixl() {
		...
		Menui.setIconImage(Toolkit.getDefaultToolkit().getImage(WindowPixl.class.getResource("/files/ikon.png")));
		...
		Gameui.setIconImage(Toolkit.getDefaultToolkit().getImage(WindowPixl.class.getResource("/files/ikon.png")));

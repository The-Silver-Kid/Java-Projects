...
public class ByteUtils {
	 ...
	 * index <code>a</code> to index <code>b</code>
	 ...
	 * method (except that null bytes (0x00),
	 * instead of whitespace, are stripped from the beginning and end). If the
	 * input array alread has no leading/trailing null bytes,

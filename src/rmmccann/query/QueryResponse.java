...
public class QueryResponse {
	...
	/**
	 * Returns a JSON string representation of the data returned from the
	 * server, useful for JSP/servlet pages with javascript.
	 * 
	...
	/**
	 * Returns an <code>ArrayList</code> of strings containing the connected
	 * players' usernames.
